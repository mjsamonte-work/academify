...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $defaults = [
            ['key' => 'school_name', 'value' => 'Academify School', 'group' => 'school_identity', 'label' => 'School Name', 'type' => 'text'],
            ['key' => 'school_code', 'value' => 'ACAD', 'group' => 'school_identity', 'label' => 'School Code', 'type' => 'text'],
            ['key' => 'school_email', 'value' => 'hello@academify.local', 'group' => 'school_identity', 'label' => 'School Email', 'type' => 'email'],
            ['key' => 'school_phone', 'value' => '555-0100', 'group' => 'school_identity', 'label' => 'School Phone', 'type' => 'text'],
            ['key' => 'school_address', 'value' => 'Academify Campus', 'group' => 'school_identity', 'label' => 'School Address', 'type' => 'textarea'],
            ['key' => 'active_school_year_id', 'value' => SchoolYear::where('name', '2026-2027')->value('id'), 'group' => 'academic_defaults', 'label' => 'Active School Year', 'type' => 'select'],
            ['key' => 'default_grading_period_id', 'value' => GradingPeriod::where('name', 'First Quarter')->value('id'), 'group' => 'academic_defaults', 'label' => 'Default Grading Period', 'type' => 'select'],
            ['key' => 'timezone_label', 'value' => 'Asia/Manila', 'group' => 'academic_defaults', 'label' => 'Timezone Label', 'type' => 'text'],
            ['key' => 'report_footer_text', 'value' => 'Generated by Academify.', 'group' => 'report_defaults', 'label' => 'Report Footer Text', 'type' => 'textarea'],
            ['key' => 'report_prepared_by_label', 'value' => 'Prepared by School Administration', 'group' => 'report_defaults', 'label' => 'Prepared By Label', 'type' => 'text'],
        ];
